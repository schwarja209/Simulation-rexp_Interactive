...
*Note: The controls below are just a demo, and do not affect any subsequent graph.*

```{r userControls, cache=TRUE}
inputPanel( #display example shiny input tools
...
inputPanel( #display example shiny display tools
    checkboxInput("means","Graph Means?",value=TRUE),
    checkboxInput("variances","Graph Density Curves?",value=TRUE),
...
```{r userGraph, fig.width=6, fig.height=4, cache=TRUE}
...
A sample of the final density curve is below, with a limited set of controls. For the full application, go [here](https://schwarja209.shinyapps.io/central_limit_theorum_demo/).

```{r finalGraph, fig.width=6, fig.height=4, cache=TRUE}
